        ...
        <footer>
            ...
            <div className="w-[95%] 800px:w-full 800px:max-w-[85%] mx-auto px-2 sm:px-6 lg:px-8 ">
                ...
                <p className='text-center text-[#333] dark:text-[#fff]'>
                    ...
                    <br />
                    {t("مشغل بواسطة/")} <Link className="border-b border-[crimson] dark:border-[#23bd70] border-solid dark:text-[#23bd70] text-[crimson]" href='https://my-portfolio0tr.vercel.app'>{t("محمود محمد")}</Link>
                </p>
            </div>
            <br />    
        </footer>
